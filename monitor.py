...
def score_token(token):
    ...
    if 3 <= age <= 12:
        ...
        warnings.append(f"🆕 Sangat baru ({age} jam)")
    elif age > 48:
        score -= 5
...
async def send_alert(bot, token, score, signal_type, signal_desc, reasons, warnings):
    ...
    msg = f"""{signal_type}
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
\U0001fa99 *{token['name']}* (${token['symbol']})
\U0001f4ca Score: *{score}/100*
\U0001f4a1 {signal_desc}
...
{chr(10).join(reasons)}"""
    ...
    msg += f"\n\n\U0001f517 [Chart & Trade]({token['pair_url']})"
...
async def do_scan(bot, manual=False):
    ...
    if manual:
        await bot.send_message(
            chat_id=config.TELEGRAM_CHAT_ID,
            text=f"\U0001f504 *Manual Scan Dimulai*\n\u23f3 Scanning... ({timestamp} WIB)",
            parse_mode=ParseMode.MARKDOWN
        )
...
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
\U0001f4ca Dipindai: {len(pairs)} token
\U0001f6ab Difilter: {filtered_count} token
\U0001f514 Alert: {alerts_sent} sinyal
\u23f0 {datetime.now().strftime('%H:%M:%S')} WIB"""
        if alerts_sent == 0:
            summary += "\n\n\U0001f4a4 Belum ada koin yang memenuhi kriteria."
        await bot.send_message(
            chat_id=config.TELEGRAM_CHAT_ID,
            text=summary,
            parse_mode=ParseMode.MARKDOWN
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    msg = """\U0001f916 *MEMECOIN MONITOR*
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
*Commands:*
...
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
\U0001f550 Auto scan: setiap {config.CHECK_INTERVAL_MINUTES} menit
\U0001f4dd Cache: {len(seen_tokens)} token
\u23f0 {datetime.now().strftime('%H:%M:%S')} WIB

*Thresholds:*
\U0001f319 Moonbag \u2265{config.SCORE_MOONBAG} | \U0001f3af Swing \u2265{config.SCORE_SWING} | \u26a1 Scalp \u2265{config.SCORE_SCALP}"""
    await update.message.reply_text(msg, parse_mode=ParseMode.MARKDOWN)
...
async def cmd_filter(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if str(update.effective_chat.id) != str(config.TELEGRAM_CHAT_ID):
        return
    msg = f"""\U0001f50d *Filter Aktif*
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
\U0001f4b0 Min Liquidity: ${config.MIN_LIQUIDITY_USD:,}
\U0001f4ca Min Volume 24h: ${config.MIN_VOLUME_24H:,}
\u23f0 Age: {config.MIN_AGE_HOURS}-{config.MAX_AGE_HOURS} jam
\U0001f6e1\ufe0f Anti wash trading: ON
\U0001f6ab Anti copycat: ON
\U0001f4c9 Anti vol manipulasi: ON"""
    await update.message.reply_text(msg, parse_mode=ParseMode.MARKDOWN)
...
async def main():
    ...
    # Build app dengan cara yang kompatibel v21.x
    app = (
        Application.builder()
    ...
    async with app:
        ...
        await bot.send_message(
            chat_id=config.TELEGRAM_CHAT_ID,
            text="""\U0001f916 *MEMECOIN MONITOR v2 AKTIF*
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
...
\u23f3 Auto scan pertama dimulai...""",
        ...
        # Jalankan polling + background scanner bersamaan
